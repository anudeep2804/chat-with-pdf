...
if uploaded_file is not None:
    ...
    AZURE_DOCUMENT_ANALYSIS_CLIENT = DocumentAnalysisClient(
        AZURE_COGNITIVE_ENDPOINT, credential)

    # Open the temporary file in binary read mode and pass it to Azure
    with open("temp_pdf_file.pdf", "rb") as f:
        poller = AZURE_DOCUMENT_ANALYSIS_CLIENT.begin_analyze_document(
    ...
    for table in doc_info["tables"]:
        ...
        markdown_table = tabulate(
            data_rows, headers=col_headers, tablefmt="pipe")
    ...
    openai_ef = embedding_functions.OpenAIEmbeddingFunction(
        api_key="your-openai-api-key", model_name="text-embedding-ada-002")
...
if prompt := st.chat_input("What do you want to say to your PDF?"):
    ...
    for r in results:
        ...
        prompt = "Please extract the following: " + prompt + \
            "  solely based on the text below. Use an unbiased and journalistic tone. If you're unsure of the answer, say you cannot find the answer. \n\n" + r
